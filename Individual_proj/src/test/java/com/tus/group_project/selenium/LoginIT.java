...
public class LoginIT {
	...
	void testAddRecipeFlow() throws InterruptedException {
		...
		String[][] ingredients = { { "Chicken", "20", "Cook" }, { "Onion", "5", "Fry" }, { "Spices", "3", "Mix" } };
		...
		for (String[] ing : ingredients) {
			...
			WebElement addIngredientBtn = wait
					.until(ExpectedConditions.elementToBeClickable(By.id("add-ingredient-btn")));
